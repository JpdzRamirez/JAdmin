<div>
    ...
    <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="{{ route('profile', ['userID' => $user->id]) }}">{{ __('navigation.profile.section') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-form">
                <div class="card-header">
                    <div class="card-title">{{ __('navigation.profile.title') }}</div>
                    <h2 style="text-align: center">{!! __('navigation.profile.sub-title', ['name' => $user->name]) !!}</h2>
                    <div class="card-category">
                        <span>{{ __('navigation.profile.span') }}</span>
                    </div>
                </div>
                <div class="card-body">
                    {{-- Name --}}
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" placeholder="{{ __('forms.register.card-placeholder') }}"
                                    class="form-control" id="card" name="card" wire:model="card" value="">
                            </div>
                        </div>
                        {{-- Company ID --}}
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary d-flex align-items-center flex-column">
                                ...
                                <input id="photo" class="form-control-file" wire:model="photo" name="photo"
